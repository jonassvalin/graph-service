(ns graph-service.relationship-resource-test
  (:require
...
(let [test-system (atom (new-test-system))]
  ...
  (deftest relationships-resource-GET-on-success
    (let [address (core/address @test-system)
          ...
          fetched-relationship-result (navigator/get relationships-result :self)

          relationships-resource (navigator/resource
                                   fetched-relationship-result)]
