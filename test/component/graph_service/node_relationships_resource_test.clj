...
(let [test-system (atom (new-test-system))]
  ...
  (deftest node-relationships-resource-GET-on-no-relationships
  ...
  (deftest node-relationships-resource-GET-on-success
    (let [address (core/address @test-system)
          ...
          relationships-result (navigator/get node-1-result :relationships)
          relationships-resource (navigator/resource relationships-result)
